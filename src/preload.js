...
contextBridge.exposeInMainWorld('cliBridge', {
  ...
  saveConversationSnapshot: (snapshot) => ipcRenderer.invoke('conversation:save-snapshot', snapshot),
  listConversationSnapshots: () => ipcRenderer.invoke('conversation:list-snapshots'),
